...
W,H=480,270; asp=W/H
NF=int(os.environ.get('NF','1440'))   # 12fps * 120s
OUT='/Users/emilianomettini/crossing_work/mandel_delirium'; os.makedirs(OUT,exist_ok=True)
import glob
...
SEND=2.5e-4  # escala final (zoom profundo)
...
for f in range(NF):
    ...
    maxi=int(200+1200*p)                         # mas iteraciones al profundizar
