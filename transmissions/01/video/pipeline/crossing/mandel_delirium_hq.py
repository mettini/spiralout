...
W,H=960,540; asp=W/H
NF=int(os.environ.get('NF','240'))   # 12fps * 120s
OUT='/Users/emilianomettini/crossing_work/mandel_hq'; os.makedirs(OUT,exist_ok=True)
import glob
...
SEND=8e-4  # escala final (zoom profundo)
