...
F=/tmp/anim/full; F2=/tmp/anim/full2; LOG=/Users/emilianomettini/outbound_work/preview.log
echo "START $(date)" > $LOG
...
ffmpeg -y -hide_banner -loglevel error \
 -framerate 24    -t 82   -i $F2/ovulo/grim/f%03d.png \
 -framerate 24    -t 138  -i /Users/emilianomettini/outbound_work/tunel_np/f%04d.png \
 -framerate 24    -t 67   -i $F2/humo/grim/f%03d.png \
 -framerate 24    -t 52   -i /tmp/anim/florseq/grim/f%03d.png \
 -framerate 24    -t 13.5 -i /tmp/anim/dis_full/grim/f%03d.png \
 -framerate 24 -start_number 504 -t 42 -i /tmp/anim/estelas/grim/f%03d.png \
 ...
 -map "[vout]" -map 9:a -c:v libx264 -crf 18 -pix_fmt yuv420p -c:a aac /Users/emilianomettini/outbound_work/OUTBOUND_PREVIEW.mp4 >> $LOG 2>&1 && echo "FINAL6 DONE $(date)" >> $LOG || echo "FINAL6 FAIL" >> $LOG
$PY -c "import subprocess;print('dur',subprocess.check_output(['ffprobe','-v','error','-show_entries','format=duration','-of','csv=p=0','/Users/emilianomettini/outbound_work/OUTBOUND_PREVIEW.mp4']).decode().strip())" >> $LOG 2>&1
